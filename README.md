...
> 当前为**河南/江苏公开数据试运行版**：基于 2025 公开数据，提供 2026 备考规划参考。院校 / 专业 / 录取以当年考试院和院校招生简章为准，本系统不构成录取承诺。
...
- **专业与院校**:基于省级考试院公开数据按科类反查招生院校;江苏使用 2025 年院校投档线,河南使用省控线与 2025 年征集志愿备档线,标注数据来源/可信度。
...
python -m scripts.scrape_henan    # 可选:重新抓取河南省控线与征集志愿计划
python -m scripts.seed            # 省份 / 专业 / 院校 / 分数线 / 城市
python -m scripts.validate_data   # 校验省控线 / 院校线 / 专业计划是否混用
...
- 当前为**河南/江苏公开数据试运行版**，使用 2025 公开数据服务 2026 备考规划参考。
...
- 成人高考**不公布逐专业录取线**。当前江苏主要按院校科类投档线匹配；河南已接入 2025 年征集志愿计划，可对部分院校做专业计划精确匹配。院校 / 专业 / 录取、专业归属、是否开设、统考科目**以当年考试院和院校招生简章为准**。
- 招生省份表示院校出现在该省考试院公开招生 / 征集计划中,不等同于院校所在地；外省院校可能在河南、江苏招生。
